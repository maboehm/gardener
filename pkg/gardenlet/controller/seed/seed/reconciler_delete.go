...
//go:generate flow-visualizer --markdown --input reconciler_delete.go --func-name runDeleteSeedFlow --destination ../../../../../docs/development/flow-graphs/gardenlet-seed-delete.md
